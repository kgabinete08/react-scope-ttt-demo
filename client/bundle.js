...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.updateBox = _this.updateBox.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: 'updateBox',
    value: function updateBox(row, i) {
      var _this2 = this;

      if (this.state.rows[row][i] !== null) return;

      this.setState(function (prevState) {
        var newRows = [].concat(_toConsumableArray(prevState.rows));
        newRows[row][i] = _this2.state.turn;
...
var Board = function Board(props) {
  ...
  var _loop = function _loop(i) {
    rows.push(_react2.default.createElement(_row2.default, { key: i, status: props.data[i], onClick: function onClick(boxId) {
        return props.onClick(i, boxId);
      } }));
  };
...
var Row = function Row(props) {
  ...
  var _loop = function _loop(i) {
    boxes.push(_react2.default.createElement(_box2.default, { key: i, status: props.status[i], onClick: function onClick() {
